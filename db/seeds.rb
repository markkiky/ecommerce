...
ApiUrl.create(:key => "app_email", :value => "info@arigiene.com")
ApiUrl.create(:key => "app_motto", :value => "Enhancing Hygiene, For A Healthier Society")
ApiUrl.create(:key => "app_phone", :value => "+ 254 743 041 695")
ApiUrl.create(:key => "app_phone_2", :value => " --- ")
ApiUrl.create(:key => "app_location", :value => "Nairobi Kenya")
ApiUrl.create(:key => "app_facebook", :value => "https://www.facebook.com/arigienekenya/")
ApiUrl.create(:key => "app_twitter", :value => "https://twitter.com/arigiene/")
ApiUrl.create(:key => "app_instagram", :value => "https://www.instagram.com/arigiene_kenya/")
...
ApiUrl.create(:key => 'whatsapp_contact', :value => '0743041695')